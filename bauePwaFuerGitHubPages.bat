...
ionic build --prod -- --base-href "https://mdecker-mobilecomputing.github.io/Ionic_Landeshauptstaedte/" --output-path=docs

@REM Diese beiden Attribute könnten auch in der Datei angular.json angepasst werden, aber wegen der Änderung von base-href
